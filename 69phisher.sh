...
# ================== INFO ==================
AUTHOR="ABNORMAL TOOL"
GITHUB="https://github.com/DIP99001"
VERSION="1.2"
...
# ================== LOADING ==================
loading() {
echo -e "${CYAN}Initializing System..."
sleep 1
echo -e "${CYAN}Connecting to servers..."
sleep 1
echo -e "${CYAN}Bypassing security..."
sleep 1
...
echo "██║  ██║██████╔╝██║ ╚████║╚██████╔╝██║ ╚═╝ ██║"
echo "╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═══╝ ╚═════╝ ╚═╝     ╚═╝"
echo -e "${CYAN}        ABNORMAL TOOL v$VERSION${RESET}"
echo -e "${WHITE}        Github: $GITHUB${RESET}"
echo
}

# ================== MAIN MENU ==================
menu() {
echo -e "${CYAN}[1] Start Tool"
echo -e "${CYAN}[2] About"
echo -e "${CYAN}[0] Exit"
echo
...
# ================== START ==================
start() {
echo -e "${GREEN}Launching ABNORMAL TOOL..."
sleep 1
echo -e "${CYAN}System Ready 🚀${RESET}"
}

# ================== ABOUT ==================
about() {
echo -e "${GREEN}Author : $AUTHOR"
echo -e "${GREEN}GitHub : $GITHUB"
